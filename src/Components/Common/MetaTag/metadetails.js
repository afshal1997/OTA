export const metaDetails = {
   'home': {
      title: 'Full-service custom web and app development company',
      description: 'Leading Android, iOS, and Web App Development Company providing affordable and customized solutions to clients in US. Outsource Your Projects Now!'
   },
   'about-us': {
