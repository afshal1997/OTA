export const StartupPricing = [
  {
    ...
    applyNowButton: {
      ...
      linkText: "#",
      buttonStyling: "PricingApplyNowBtn w-100",
    },
  },
  {
    type: "STANDARD",
    pricing: "$1,499",
    description:
      "In this plan we are offering you standard services so you can start up your new home based business in very low amount.",
    services: [
      "Logo Design",
      "Brand Website",
      "Social Media Presence",
      ...
      "Dialpad & Zendesk",
      "Hosting for 6 Month",
      "Lead Generation (PPC or Facebook USD 400)",
      "-",
      "-",
    ],
