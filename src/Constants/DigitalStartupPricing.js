export const StartupPricing = [
    {
        ...
        services: ['Logo Design', 'Brand Website',  'Social Media Presence', 'Marketing Material','Operational Support','Dialpad & Zendesk', 'xxx', 'xxx','xxx','xxx'],
        classes: '',
    ...
    },
    {
        ...
        pricing: '$1,299',
        description: 'In this plan we are offering you basic services so you can start up your new home based business in very low amount.',
        services: ['Logo Design', 'Brand Website',  'Social Media Presence', 'Marketing Material','Operational Support','Dialpad & Zendesk', 'Hosting for 6 Month', 'Lead Generation (PPC or Facebook USD 400)','xxx','xxx'],
