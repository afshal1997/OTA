...
import { AndroidAppService, ExclusiveAppDevelopmentService } from '../../../Constants/AppDevelopmentServices';
            ...
            <Container>
                <Row>
                    <Col lg={4} className="m-auto">
                        <Bounce right cascade>
                            <div className="StartUp">
                                <span class="BgText">{ExclusiveAppDevelopmentService.heading}</span>
                    ...
                    <Col lg={7} className="m-auto">
                        <Bounce right>
                            <h6>
                                <b>
                                    {ExclusiveAppDevelopmentService.description}
                                </b>
                            </h6>
                        </Bounce>
                    </Col>
                ...
                <Row>
                    <Col lg={5} className="m-auto">
                        <Bounce left cascade>
                            <img className="w-100" src={AndroidAppService.AndroidAppServiceImgPath} alt=""></img>
                        </Bounce>
                    </Col>
                    <Col lg={7} className="m-auto">
                        <Bounce right cascade>
                            <div className="StartUp pt-5 mt-5">
                                ...
                                <div className="OurServicesHeadingUl">
                                    <ul>
                                        ...
                                        <Col lg="3">
                                            <a href="" class={`${AndroidAppService.button[1]}`}>{AndroidAppService.button[0]}</a>
                                        </Col>
                                    </ul>
                                </div>
