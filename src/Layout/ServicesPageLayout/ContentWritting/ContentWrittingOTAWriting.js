...
import { BlogWritingService, OTAWrittingService } from '../../../Constants/ContentWrittingServices';
            ...
            <Container>
                <Row>
                    ...
                    <Col lg={7} className="m-auto">
                        <Bounce right>
                            <h6>
                                <b>
                                    {OTAWrittingService.description}
                                </b>
                            </h6>
                        </Bounce>
                    </Col>
                ...
                <Row>
                    <Col lg={5} className="m-auto">
                        <Bounce left cascade>
                            <img className="w-100" src={BlogWritingService.BlogWritingServiceImgPath} alt=""></img>
                        </Bounce>
                    </Col>
                    <Col lg={7} className="m-auto">
                        <Bounce right cascade>
                                ...
                                <div className="OurServicesHeadingUl">
                                    <ul>
                                        ...
                                        <Fade>
                                            <h6>
                                                <b>
                                                    {BlogWritingService.description}
                                                </b>
                                            </h6>
                                            <Row>
                                        ...
                                        <Col lg="3">
                                            <a href="" class={`${BlogWritingService.button[1]}`}>{BlogWritingService.button[0]}</a>
                                        </Col>
                                    </ul>
                                </div>
