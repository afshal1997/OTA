            ...
            <Container>
                <Row>
                            ...
                            <div className="StartUp pt-5 mt-5">
                                ...
                                <div className="OurServicesHeadingUl">
                                    <ul>
                                        ...
                                        <Col lg="3">
                                            <a href="" class={`${ArticleWriting.button[1]}`}>{ArticleWriting.button[0]}</a>
                                        </Col>
                                    </ul>
                                </div>
                            </div>
                    ...
                    <Col lg={5} className="m-auto">
                        <Bounce right cascade>
                            <img className="w-100" src={ArticleWriting.ArticleWritingImagePath} alt=""></img>
                        </Bounce>
                    </Col>
                </Row>
            </Container>
