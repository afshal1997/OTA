                        ...
                        <Col lg={6} className="m-auto">
                            <div className="Outsource mt-5 mb-5">
                                <svg width="100%">
                                    ...
                                    <g>
                                        <text id="text" y="103" strokeWidth="1" stroke="url(#gradient)" fill="rgb(0, 0, 0,0.2)">Best</text>
                                    </g>
                                </svg>
                                <h1><Fade top cascade>Video Animation</Fade></h1>
                                <p>
                                    <Bounce left cascade>
                                        Add graphics & voice to your digital business story through engaging video development  that helps customers understand you better.
                                    </Bounce>
                                </p>
                                <Row>
                                    <Col lg={4}>
