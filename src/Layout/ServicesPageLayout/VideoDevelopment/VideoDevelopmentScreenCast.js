            ...
            <Container>
                <Row>
                    <Col lg={5} className="m-auto">
                        <Bounce left cascade>
                            <img className="w-100" src={ScreenCastService.ScreenCastServiceImagePath} alt=""></img>
                        </Bounce>
                    </Col>
                            ...
                            <div className="StartUp pt-5 mt-5">
                                ...
                                <div className="OurServicesHeadingUl">
                                    <ul>
                                        ...
                                        <Col lg="3">
                                            <a href="" class={`${ScreenCastService.button[1]}`}>{ScreenCastService.button[0]}</a>
                                        </Col>
                                    </ul>
                                </div>
