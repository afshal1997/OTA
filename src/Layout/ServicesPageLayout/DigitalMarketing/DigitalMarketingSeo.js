...
import { SearchEngineOptimization, TheExpertiseOf } from '../../../Constants/DigitalMarketingServices';
            ...
            <Container>
                ...
                <Row>
                    <Col lg={5} className="m-auto">
                        <Bounce left cascade>
                            <img className="w-100" src={SearchEngineOptimization.SearchEngineOptimizationImagePath} alt=""></img>
                        </Bounce>
                    </Col>
                    <Col lg={7} className="m-auto">
                        <Bounce right cascade>
                                ...
                                <div className="OurServicesHeadingUl">
                                    <ul>
                                        ...
                                        <Fade>
                                            <h6>
                                                <b>
                                                    {SearchEngineOptimization.description}
                                                </b>
                                            </h6>
                                            <Row>
                                        ...
                                        <Col lg="3">
                                            <a href="" class={`${SearchEngineOptimization.button[1]}`}>{SearchEngineOptimization.button[0]}</a>
                                        </Col>
                                    </ul>
                                </div>
