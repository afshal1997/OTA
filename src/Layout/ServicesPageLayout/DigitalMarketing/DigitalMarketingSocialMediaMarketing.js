            ...
            <Container>
                <Row>
                                ...
                                <div className="OurServicesHeadingUl">
                                    <ul>
                                        ...
                                        <Fade>
                                            <h6>
                                                <b>
                                                    {SocialMediaMarketing.description}
                                                </b>
                                            </h6>
                                            <Row>
                                        ...
                                        <Col lg="3">
                                            <a href="" class={`${SocialMediaMarketing.button[1]}`}>{SocialMediaMarketing.button[0]}</a>
                                        </Col>
                                    </ul>
                                </div>
                    ...
                    <Col lg={5} className="m-auto">
                        <Bounce left cascade>
                            <img className="w-100" src={SocialMediaMarketing.SocialMediaMarketingImagePath} alt=""></img>
                        </Bounce>
                    </Col>
                </Row>
            </Container>
