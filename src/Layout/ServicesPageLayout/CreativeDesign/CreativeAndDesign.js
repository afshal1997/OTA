                        ...
                        <Col lg={6} className="m-auto">
                            <div className="Outsource mt-5 mb-5">
                                <svg width="100%">
                                    ...
                                    <g>
                                        <text id="text" y="103" strokeWidth="1" stroke="url(#gradient)" fill="rgb(0, 0, 0,0.2)">Brand</text>
                                    </g>
                                </svg>
                                <h1><Fade top cascade>Creative Designing</Fade></h1>
                                <p>
                                    <Bounce left cascade>
                                        Represent Your Brand with State-of-the-Art Designs That Explains Your Story Even Better – It Eventually
                                        Becomes a Reality!
                                    </Bounce>
                                </p>
                                <Row>
