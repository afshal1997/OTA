            ...
            <Container>
                <Row>
                                ...
                                <div className="OurServicesHeadingUl">
                                    <ul>
                                        ...
                                        <Fade>
                                            <h6>
                                                <b>
                                                    {DesignCustomWebsite.description}
                                                </b>
                                            </h6>
                                            <Row>
                                        ...
                                        <Col lg="3">
                                            <a href="" class={`${DesignCustomWebsite.button[1]}`}>{DesignCustomWebsite.button[0]}</a>
                                        </Col>
                                    </ul>
                                </div>
                    ...
                    <Col lg={5} className="m-auto">
                        <Bounce left cascade>
                            <img className="w-100" src={DesignCustomWebsite.DesignCustomWebsiteImagePath} alt=""></img>
                        </Bounce>
                    </Col>
                </Row>
            </Container>
