            ...
            <Container>
                <Row>
                    <Col lg={5} className="m-auto">
                        <Bounce left cascade>
                            <img className="w-100" src={OptimizeEcommerceWebsite.OptimizeEcommerceWebsiteImagePath} alt=""></img>
                        </Bounce>
                    </Col>
                                ...
                                <div className="OurServicesHeadingUl">
                                    <ul>
                                        ...
                                        <Fade>
                                            <h6>
                                                <b>
                                                    {OptimizeEcommerceWebsite.description}
                                                </b>
                                            </h6>
                                            <Row>
                                        ...
                                        <Col lg="3">
                                            <a href="" class={`${OptimizeEcommerceWebsite.button[1]}`}>{OptimizeEcommerceWebsite.button[0]}</a>
                                        </Col>
                                    </ul>
                                </div>
