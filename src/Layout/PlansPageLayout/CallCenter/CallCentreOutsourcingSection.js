                        ...
                        <Bounce left cascade>
                            <div className="Operating">
                                <svg width="100%">
                                    ...
                                    <g>
                                        <text id="text" y="103" strokeWidth="1" stroke="url(#gradient)" fill="rgb(0, 0, 0,0.2)">Operating</text>
                                    </g>
                                </svg>
                                ...
                                <h5>
                                    “A complete outsource of the Call Centre is likely to
                                    yield between a <b>20-30%</b> cost saving on operating costs to the company”.
                                </h5>
                                <Row>
                                    <Col lg={4}>
