          ...
          <Col lg={6}>
            <Bounce left cascade>
              <div className="planServicesSvg">
                ...
                <h1>
                  Outsourcing <br></br> Human Resources
                </h1>
                <p>
                  <b>
                    <i>
                ...
                <p>
                  Being the most difficult process in the company which is
                  directly related to the performance of a firm is just made
                  easy by our human resources professional who extracts the
                  right people for your organization making sure that needs are
                  met and when we say we will do it, then we make sure it
                  happens!
                </p>
                <Row>
                  <Col lg={4}>
