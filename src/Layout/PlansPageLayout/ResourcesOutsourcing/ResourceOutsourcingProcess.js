                    ...
                    <div className="WhyChooseUs">
                        ...
                        <Row className="mobile-view">
                            <Col>
                                <Card className="WhyChooseUSCards">
                                    <Col lg={8} className="m-auto text-center p-0">
                                        <img className="w-50 position-relative mb-4" src={ResourcesOutsourcingBusinessIcon03} alt="ResourcesOutsourcing"></img>
                            ...
                            <Col>
                                <Card className="WhyChooseUSCards">
                                    <Col lg={8} className="m-auto text-center p-0">
                                        ...
                                        <img className="w-50 position-relative mb-4" src={ResourcesOutsourcingBusinessIcon04} alt="ResourcesOutsourcing"></img>
                                    </Col>
                                </Card>
                            </Col>
                            ...
                            <Col>
                                <Card className="WhyChooseUSCards">
                                    <Col lg={8} className="m-auto text-center p-0">
                                        <img className="w-50 position-relative mb-4" src={ResourcesOutsourcingBusinessIcon05} alt="ResourcesOutsourcing"></img>
                            ...
                            <Col>
                                <Card className="WhyChooseUSCards">
                                    <Col lg={8} className="m-auto text-center p-0">
                                        ...
                                        <img className="w-50 position-relative mb-4" src={ResourcesOutsourcingBusinessIcon06} alt="ResourcesOutsourcing"></img>
                                    </Col>
                                </Card>
                            </Col>
                        </Row>
