                        ...
                        <Col lg={6} className="m-auto">
                            <div className="Outsource mt-5 mb-5">
                                <svg width="100%">
                                    ...
                                    <g>
                                        <text id="text" y="103" strokeWidth="1" stroke="url(#gradient)" fill="rgb(0, 0, 0,0.2)">Platform</text>
                                    </g>
                                </svg>
                                <h1><Fade top cascade>Affordable & Reliable</Fade></h1>
                                <h3><Bounce right cascade>White Labelling Platform</Bounce></h3>
                                <p>
                                    <Bounce left cascade>
